...
mod tests {
    ...
    fn markdown_exports_real_package_fields() {
        ...
        let markdown = package_to_markdown(&package, &ExportOptions::default()).unwrap();
    ...
    fn plain_text_exports_real_package_fields() {
        let package = real_package();
        let text = package_to_plain_text(&package, &ExportOptions::default()).unwrap();
